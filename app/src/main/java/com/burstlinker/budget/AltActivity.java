    ...
    public void displayStats()
    {
        statButton.setOnClickListener(
                new Button.OnClickListener()
                {
                    ...
                    {
                        Intent go_displayStats = new Intent(AltActivity.this,StatFragment.class);
    ...
    public void displayData()
    {
       displayButton.setOnClickListener(
               new Button.OnClickListener()
               {
                   ...
                   public void onClick(View v)
                   {
                       Intent go_displayData = new Intent(AltActivity.this,HistoryFrag.class);
                    ...
                    public void onClick(View v) {
                      //  ConnectivityManager cmanager = (ConnectivityManager) getSystemService(Context.CONNECTIVITY_SERVICE);
                       // NetworkInfo networkInfo = cmanager.getActiveNetworkInfo();
                        ...
                        //}
                        Intent go_displayData = new Intent(AltActivity.this,MainActivity.class);
                        startActivity(go_displayData);
                    }
                }
        );
